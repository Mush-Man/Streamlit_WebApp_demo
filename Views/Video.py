...
# Load YOLO models
model_road = YOLO("https://github.com/Mush-Man/Streamlit_WebApp_demo/blob/main/best.pt")
model_bridge = YOLO("https://github.com/Mush-Man/Streamlit_WebApp_demo/blob/main/best (1).pt")
